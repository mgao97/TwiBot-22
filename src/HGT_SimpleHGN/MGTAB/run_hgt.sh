...
# nohup python HGT_sample.py --seed $SEED2 2>&1 | tee logs/hgt_seed_${SEED2}.log
# echo "实验2完成"

# # 运行第三个实验
# echo "开始运行实验3，种子值: $SEED3"
# python HGT_sample.py --seed $SEED3 2>&1 | tee logs/hgt_seed_${SEED3}.log
# echo "实验3完成"

# # 运行第四个实验
# echo "开始运行实验4，种子值: $SEED4"
# python HGT_sample.py --seed $SEED4 2>&1 | tee logs/hgt_seed_${SEED4}.log
# echo "实验4完成"

# # 运行第三个实验
# echo "开始运行实验5，种子值: $SEED5"
# python HGT_sample.py --seed $SEED5 2>&1 | tee logs/hgt_seed_${SEED5}.log
# echo "实验5完成"

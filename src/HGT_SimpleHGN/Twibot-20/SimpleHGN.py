...
class SHGNDetector(pl.LightningModule):
    def __init__(self, args):
        ...
        self.edge_index = torch.load(args.path + "edge_index.pt", map_location="cpu")
        self.edge_type = torch.load(args.path + "edge_type.pt", map_location="cpu").long()
    ...
    def test_step(self, test_batch, batch_idx):
        ...
        with torch.no_grad():
            ...
            # 保存结果到CSV
            results_df.to_csv('SimpleHGN_twi20.csv', mode='a', header=not os.path.exists(f'SimpleHGN_twi20.csv'), index=False)
            ...
            print("acc: {} \t f1: {} \t precision: {} \t recall: {} \t auc: {} \t aucpr: {}".format(acc, f1, precision, recall, Auc, aucpr))
...
if __name__ == "__main__":
    ...
    # best_path = './simplehgn/lightning_logs/version_0/checkpoints/val_acc=0.8706.ckpt'

    best_model = SHGNDetector.load_from_checkpoint(checkpoint_path=best_path, args=args,strict=False)

...
nohup python SimpleHGN_sample.py --seed $SEED1 > logs/simhgn_seed_${SEED1}.log 2>&1 &
echo "实验1完成"

# # 运行第二个实验
# echo "开始运行实验2，种子值: $SEED2"
# nohup python SimpleHGN_sample.py --seed $SEED2 > logs/simhgn_seed_${SEED2}.log 2>&1 &
# echo "实验2完成"

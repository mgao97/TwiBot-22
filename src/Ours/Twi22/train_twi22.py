...
class BotHybrid(pl.LightningModule):
    def __init__(self,args):
        ...
        self.linear_relu_input=nn.Sequential(
            nn.Linear(1544,args.hid_channels),
            nn.LeakyReLU()
        )
        
        self.rgcn=RGCNConv(args.hid_channels,args.hid_channels,num_relations=2)
...
parser.add_argument("--hid_channels", type=int, default=1544, help="hidden channel")

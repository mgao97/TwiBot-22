...
# feature_extract=pipeline('feature-extraction',model=model,tokenizer=tokenizer,device='cpu',padding=True, truncation=True,max_length=50)

# def Des_embbeding():
#         print('Running feature1 embedding')
#         path="/dev/shm/twi20/data/des_tensor.pt"
...
# 嵌入函数
def Des_embedding(batch_size=64, max_length=50):
    print('Running feature1 embedding')
    path = "/dev/shm/twi20/data/des_tensor_t5.pt"
